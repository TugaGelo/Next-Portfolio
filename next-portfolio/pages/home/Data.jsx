...
const Data = () => {
  return (
    <div className={styles.home__data}>
        <h1 className={styles.home__title}>Tugaoen, Roland Angelo B.
            <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
        ...
        <h3 className={styles.home__subtitle}>IT Student</h3>
        <p className={styles.home__description}>I'm a driven web developer focused on crafting innovative and efficient digital solutions.</p>

        <a href="https://www.facebook.com/rolandtugaoen2016/" className="button buttonFlex">
        Say Hello  
        <svg
